...
const VentaProducto = () => {
  ...
  const manejarEditarVenta = (venta) => {
    setFormData({
  ...
  // Función para obtener clases de color basadas en el estado, replicando la lógica del inventario
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        {/* Eliminado: Título "Gestión de Ventas" */}
        {/* <h1 className="text-3xl font-bold text-white mb-8 text-center sm:text-4xl lg:text-5xl">
        ...
        <div className="text-center mb-8">
          ...
          >
            ...
            {mostrarFormulario ? "Ocultar Formulario" : "Nueva Venta"}
          </button>
        </div>
        ...
        {mostrarFormulario && (
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8 backdrop-blur-sm bg-white/90">
            ...
            <form onSubmit={manejarGuardarVenta} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Columna Izquierda */}
          ...
          {ventas.map((venta) => (
            ...
            >
              ...
              <div className="flex justify-between space-x-2">
                ...
                <button
                  onClick={() => manejarEditarVenta(venta)}
