...
const DashboardEntrenamiento = () => {
  const navigate = useNavigate();

  // Datos de las cards para Gestión de Entrenamiento
  const sections = [
    {
      ...
      cards: [
        {
          id: 1,
          title: "Rutinas",
          description: "Crear y gestionar rutinas de entrenamiento",
          icon: "https://cdn-icons-png.flaticon.com/512/2936/2936886.png",
          route: "/entrenamiento/rutinas",
          bgColor: "bg-blue-50",
          iconColor: "text-blue-500"
        },
        {
          id: 2,
          title: "Fichas de Entrenamiento",
          description: "Administrar fichas técnicas de ejercicios",
          icon: "https://cdn-icons-png.flaticon.com/512/3652/3652191.png",
          route: "/entrenamiento/fichas",
          bgColor: "bg-green-50",
        ...
        },
        {
          ...
          description: "Registrar y consultar evaluaciones físicas",
          icon: "https://cdn-icons-png.flaticon.com/512/3059/3059518.png",
          route: "/entrenamiento/evaluaciones",
          bgColor: "bg-purple-50",
          iconColor: "text-purple-500"
        }
      ],
      mainIcon: "https://cdn-icons-png.flaticon.com/512/1830/1830839.png"
    }
  ];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <section className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-lg p-6 flex flex-col items-center text-center h-full transition-all duration-500 hover:shadow-xl backdrop-blur-sm bg-white/80">
                    ...
                    <p className="text-gray-600 mt-2">Gestión completa del área de entrenamiento</p>
                  </section>
                </div>
